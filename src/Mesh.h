...
struct Boundary {
   ...
   * \param ngg = 0 number of ghost grids in each direction
   */
  void register_boundary(int dim, int ngg = 0);
...
public:
  ...
  template<int ORDER> void compute_jac_metric_symmetric_conservative(int myid);
